...
export type ProjectByIdQuery = {
    ...
    websiteProjectById?: {
        ...
        body: string,
        otherContacts?: Array<string> | null,
        ...
        collaborators: {
            ...
            edges: Array<{
                ...
                node?: { __typename?: 'CollaboratorNode', name: string, thumbnail: string, url?: string | null } | null
            } | null>
        }
    } | null
};
...
export type HomeCollaboratorsQuery = {
    __typename?: 'Query',
    allCollaborators?: {
        __typename?: 'CollaboratorNodeNodeConnection',
        results: Array<{ __typename?: 'CollaboratorNode', name: string, thumbnail: string, url?: string | null } | null>
    } | null
};
...
export type AllDeploymentsQuery = {
    __typename?: 'Query', allDeployments?: {
        __typename?: 'DeploymentNodeNodeConnection', results: Array<{
            ...
            recoveryDate?: any | null,
            project: { __typename?: 'ProjectNodeOverride', id: string, name: string },
            site?: { __typename?: 'SiteNode', id: string, name: string } | null,
            campaign?: { __typename?: 'CampaignNode', id: string, name: string } | null,
            contacts?: Array<{
                __typename?: 'ContactRelationNode',
                id: string,
                role?: Types.RoleEnum | null,
                contact?: { __typename?: 'InstitutionNode', name: string } | {
                    __typename?: 'PersonNode',
                    firstName: string,
                    lastName: string
                } | { __typename?: 'TeamNode', name: string } | null
            } | null> | null,
...
export type DeploymentByIdQuery = {
    ...
    annotationLabelsForDeploymentId?: {
        ...
        results: Array<{ __typename?: 'AnnotationLabelNode', id: string, name: string, uses: number } | null>
    } | null,
    deploymentById?: {
        __typename?: 'DeploymentNode',
        name?: string | null,
        ...
        longitude: number,
        deploymentDate?: any | null,
        deploymentVessel?: string | null,
        recoveryDate?: any | null,
        recoveryVessel?: string | null,
        bathymetricDepth?: number | null,
        description?: string | null,
        project: {
            __typename?: 'ProjectNodeOverride',
            name: string,
            accessibility?: Types.AccessibilityEnum | null,
            projectGoal?: string | null,
            contacts?: Array<{
                __typename?: 'ContactRelationNode',
                id: string,
                role?: Types.RoleEnum | null,
                contact?: { __typename?: 'InstitutionNode', name: string, website?: string | null } | {
                    __typename?: 'PersonNode',
                    firstName: string,
                    lastName: string,
                    website?: string | null
                } | { __typename?: 'TeamNode', name: string, website?: string | null } | null
            } | null> | null
        },
        site?: { __typename?: 'SiteNode', name: string } | null,
        campaign?: { __typename?: 'CampaignNode', name: string } | null,
        platform?: { __typename?: 'PlatformNode', name?: string | null } | null,
        contacts?: Array<{
            __typename?: 'ContactRelationNode',
            id: string,
            role?: Types.RoleEnum | null,
...
export type AllBibliographyQuery = {
    __typename?: 'Query', allBibliography?: {
        __typename?: 'BibliographyUnionConnection', edges: Array<{
            __typename?: 'BibliographyUnionEdge',
            node?: {
                __typename?: 'ArticleNode',
                title: string,
                doi?: string | null,
                status: Types.BibliographyStatusEnum,
                type: Types.BibliographyTypeEnum,
                ...
                pagesTo?: number | null,
                issueNb?: number | null,
                articleNb?: number | null,
                tags?: Array<{ __typename?: 'TagNode', name: string } | null> | null,
                authors: {
                ...
                conferenceAbstractBookUrl?: string | null,
                tags?: Array<{ __typename?: 'TagNode', name: string } | null> | null,
                authors: {
                    __typename?: 'AuthorNodeConnection',
                    edges: Array<{
...
export type AllTeamMembersQuery = {
    ...
    allTeamMembers?: {
        ...
        results: Array<{
            ...
            position: string,
            isFormerMember: boolean,
            person: { __typename?: 'PersonNode', initialNames?: string | null, firstName: string, lastName: string }
        } | null>
    } | null
};
...
export type TeamMemberByIdQuery = {
    ...
    teamMemberById?: {
        ...
        person: { __typename?: 'PersonNode', firstName: string, lastName: string, initialNames?: string | null }
    } | null
};
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        allProjects(variables: AllProjectsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
        ...
        projectById(variables: ProjectByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
            data: ProjectByIdQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
        ...
        homeCollaborators(variables?: HomeCollaboratorsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
            data: HomeCollaboratorsQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
        ...
        allDeployments(variables?: AllDeploymentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
            data: AllDeploymentsQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
        ...
        deploymentById(variables: DeploymentByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
            data: DeploymentByIdQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
        ...
        allBibliography(variables?: AllBibliographyQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
            data: AllBibliographyQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
        ...
        allTeamMembers(variables?: AllTeamMembersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
            data: AllTeamMembersQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
        ...
        teamMemberById(variables: TeamMemberByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
            data: TeamMemberByIdQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
