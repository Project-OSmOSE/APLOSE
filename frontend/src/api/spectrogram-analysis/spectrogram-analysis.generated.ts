...
export type ListAvailableSpectrogramAnalysisForImportQuery = { __typename?: 'Query', allSpectrogramAnalysisForImport?: Array<{ __typename?: 'ImportSpectrogramAnalysisType', name: string, path: string } | null> | null, datasetById?: { __typename?: 'DatasetNode', name: string, path: string } | null };
...
export type ImportSpectrogramAnalysisMutation = { __typename?: 'Mutation', importSpectrogramAnalysis?: { __typename?: 'ImportSpectrogramAnalysisMutation', ok?: boolean | null } | null };
