...
const NewAnnotationCampaign: React.FC = () => {
    ...
    // Data
    const [ datasetID, setDatasetID ] = useState<string | undefined>(dataset_id ?? undefined);
    ...
    return useMemo(() => <div className={ styles.page } ref={ page }>
            ...
            <FormBloc label="Spectrogram Tuning">
                ...
                { allowColormapTuning &&
                    <Input type="checkbox" label="Invert default colormap" disabled={ !isColormapEditable }
