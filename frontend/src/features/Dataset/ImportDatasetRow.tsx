...
import { FolderCheck, FolderError, MoveToFolder } from '@solar-icons/react';
...
export const ImportDatasetRow: React.FC<{
    ...
    return <ImportRow downloadedIcon={ <FolderCheck size={ 24 } weight="BoldDuotone"/> }
                      ...
                      failedIcon={ <FolderError size={ 24 } weight="BoldDuotone"/> }
                      isDownloaded={ isDownloaded }
                      isLoading={ isLoading }
                      isFailed={ dataset.failed }
                      errorStack={ dataset.stack }
                      name={ dataset.name }
                      path={ dataset.path }
