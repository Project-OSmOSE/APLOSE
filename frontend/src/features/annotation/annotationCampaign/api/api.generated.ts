...
export const GetAnnotationCampaignsDocument = `
    query getAnnotationCampaigns($annotatorID: Decimal, $ownerID: Decimal, $isArchived: Boolean, $phase: AnnotationPhaseType, $search: String) {
...
const injectedRtkApi = gqlAPI.injectEndpoints({
  endpoints: (build) => ({
    getAnnotationCampaigns: build.query<GetAnnotationCampaignsQuery, GetAnnotationCampaignsQueryVariables | void>({
