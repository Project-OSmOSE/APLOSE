...
import { InstitutionSelect, TeamSelect } from '../input';

export const NewPersonForm: React.FC<CreateDialog.FormProps<API.PersonFragment, API.CreatePersonMutationVariables['input']>> = ({
                                                                                                                                    input,
                                                                                                                                    onCreate,
                                                                                                                                }) => {
